...
ActiveRecord::Schema.define(version: 20_180_628_201_821) do
  ...
  create_table 'translations', force: :cascade do |t|
    ...
    t.index %w[text_id language_id category], name: 'index_translations_on_text_id_and_language_id_and_category'
  end
