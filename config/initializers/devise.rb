...
Devise.setup do |config|
  ...
  config.mailer_sender = 'Thorsten@locationguru.net <noreply@locationguru.net>'
  ...
  # config.pepper = '7ae98ff2ef7db75f6b617aaaa63237e5d35dfb69cc8e0230d619c662ca9e468cbb96233cf5ace3269813d8b3b4d1eac2ededbe8bc0d3971e25d2b43a55f6fcaa'
  ...
  config.omniauth :facebook, ENV['FACEBOOK_APP_ID'], ENV['FACEBOOK_APP_CODE'], scope:'email', info_fields: 'email, name'
